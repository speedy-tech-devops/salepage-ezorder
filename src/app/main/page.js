    ...
    <div className="page-wrapper py-3">
      <div className="container">
        ...
        <div className="row mb-4">
          <div className="col-lg-6 mb-3">
            <div className="bg-secondary rounded p-3">
              <img className="mw-100 rounded" src="https://d9hhrg4mnvzow.cloudfront.net/business.wongnai.com/foodstory/leadform/0154cda9-da66-473a-8d50-7838415fa053-screenshot-2023-10-27-002305.png" />
            </div>
          </div>
          <div className="col-lg-6 mb-3">
            <div className="border_dark_blue rounded p-3">
              ...
              <form>
                ...
                <div className="row">
                  <div className="form-group col-sm-12 mb-3">
                    <label className="mb-1 " htmlFor="inputState">สนใจติดต่อเรื่องใด</label>
                    <select id="inputState" className="border_dark_blue form-control">
                      <option selected>โปรดเลือกเรื่องที่ต้องการติดต่อ</option>
                      <option>ติดต่อพนักงาน สนใจใช้งานระบบ FoodStory POS</option>
                      <option>ต่ออายุการใช้งาน FoodStory POS</option>
                ...
                <div className="row">
                  <div className="form-group col-sm-12 mb-3">
                    <label className="mb-1 " htmlFor="inputState">ท่านสนใจ POS รุ่นใด</label>
                    <select id="inputState" className="border_dark_blue form-control">
                      <option selected>FoodStory POS (iPad)</option>
                ...
                <div className="row">
                  <div className="form-group col-sm-12 mb-4">
                    <label className="mb-1 " htmlFor="inputState">คุณรู้จัก FoodStory จากไหน*</label>
                    <select id="inputState" className="border_dark_blue form-control">
                      <option selected>คุณรู้จัก FoodStory จากไหน</option>
                      <option>Facebook</option>
                      <option>Google</option>
                      <option>Instagram</option>
                      <option>Tiktok</option>
                      <option>YouTube</option>
                      <option>บทความบนเว็บไซต์ www.foodstory.co</option>
        ...
        <div className="row mb-5 gx-3">
          ...
          <div className="col-4">
            <img className="mw-100 " src="images/comment_1.png" />
          </div>
          <div className="col-4">
            <img className="mw-100 " src="images/comment_2.png" />
          </div>
          <div className="col-4">
            <img className="mw-100 " src="images/comment_3.png" />
          </div>
        </div>
      </div>
    </div>
